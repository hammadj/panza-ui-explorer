...
import { ButtonGroup, Button } from 'panza'

function noop(){}

exports.displayName = 'ButtonGroup'
exports.title = 'ButtonGroup'
exports.description = 'Group buttons together to create tabs, segmented controls, etc.,'
